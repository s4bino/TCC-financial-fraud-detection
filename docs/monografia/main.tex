...
\usepackage[colorlinks=true,
          ...
          pdfkeywords={Fraudes. 2. DBSCAN . 3. Machine Learning. 4. Classificação.}%
...
\title{Detecção de fraudes financeiras: Algoritmo não supervisionado de agrupamento DBSCAN em comparação com abordagens supervisionadas de classificação Random Forest e XGBoost}
\subtitle{}
\engtitle{}
\engsubtitle{}
\edicao{}
...
\orientador{-}
\coorientador{Elaine Cecilia Gatto} % comente se não tiver coorientador
\local{Lavras -- MG}
\bancaum{ - }{UFLA}
\bancadois{ - }{UFLA} 
\defesa{ - }
...
% palavras-chave
\palchaves{Fraudes Financeiras; Aprendizado de Máquina; DBSCAN; Agrupamento; Classificação.}

\resumo{ - }  

% keywords devem vir antes do abstract
\keywords{Financial Fraud; Machine Learning; DBSCAN; Clustering; Classification.} % keywords
